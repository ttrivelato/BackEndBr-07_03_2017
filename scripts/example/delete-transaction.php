...
$log->logar("Delete Transaction: ".$data['TRANSACTION_ID']." ".print_r($data,true),"delete-transaction/");
...
try {    
    ...
    $log->logar(print_r($response,true),"delete-transaction/");
    
} catch (Exception $e) {    
    $log->logar(print_r($e,true),"delete-transaction/");   
}