...
$log->logar("Search Transaction: ".$data['TRANSACTION_ID']." ".print_r($data,true),"search-transaction/");
...
try {    
    ...
    $log->logar(print_r($response,true),"search-transaction/");
    
} catch (Exception $e) {    
    $log->logar(print_r($e,true),"search-transaction/");   
}